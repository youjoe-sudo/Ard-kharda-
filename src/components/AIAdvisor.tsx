...
interface AIAdvisorProps {
  calculatorData: any;
  challengesData: any;
  apiKey?: string; // <--- ضيف السطر ده هنا (الاستفهام معناها إنه اختياري)
}
...
export function AIAdvisor({ calculatorData, challengesData }: AIAdvisorProps) {
  ...
  return (
    <div className="bg-linear-to-r from-emerald-900 to-emerald-800 rounded-2xl p-6 text-white shadow-lg relative overflow-hidden">
      {/* Background Pattern */}
